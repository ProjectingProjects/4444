...
function toggle(event){
  ...
  if($("#"+thisID).is($("#"+thisTabID+" #available"))){
    $("#"+thisTabID+" #NOTavailable").css("background-color", availColors[0]);
    $("#"+thisTabID+" #NOTavailable").css("color", availFontColors[0]);
  }
  else if($("#"+thisID).is($("#"+thisTabID+" #NOTavailable"))){
    $("#"+thisTabID+" #available").css("background-color", availColors[0]);
    $("#"+thisTabID+" #available").css("color", availFontColors[0]);
  }
  else
